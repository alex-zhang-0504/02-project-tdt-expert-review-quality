...
本目录存放已停止维护的历史版本文件，仅供追溯，**不得作为当前规则或字段依据**。

| 文件 | 归档日期 | 原因 |
|---|---|---|
| `tdr-expert-review-quality-assessment-v0.1.md` | 2026-08-04 | 五项评分＋主席附加分＋后验修正＋H1／H2看板，V0.2 已整体重构为两维 |
| `tdrx-review-and-score-data-spec-v0.1.md` | 2026-08-04 | 配套 V0.1 办法的字段与公式定义，已作废 |
